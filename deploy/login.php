          ...
          <div id="login">
            <table border="0" width="500">
                  ...
                  <fieldset>
                    ...
                    <form action="/login-redirect.php" method="post">
                      <table cellpadding="2" cellspacing="0" border="0" class="login-table">
                        <tr>
                          <td colspan="2"><?php echo t("Welcome back. To access your account, enter your email and password."); ?></td>
                        </tr>
                        <?php
                        if ($_GET['fail'] == "true") {
                        ?>
              ...
              <tr>
                <td>
                  <fieldset>
                    <legend>&raquo; <?php echo t("Reset Password"); ?></legend>
                    <form action="/login.php?a=reset" method="post">
                      <table cellpadding="2" cellspacing="0" border="0" class="login-reset-table">
                        <?php
                        if ($action === "reset") {
                          echo "<tr class=\"success\"><td align=\"center\" colspan=\"2\">" . t("A temporary password has been emailed to you.") . "</td></tr>";
                        }
                        ?>
                        <tr>
                          <td colspan="2"><?php echo t("Enter your email address and a new password will be immediately sent to you. You may change your replacement password later under Sign In."); ?></td>
                        </tr>
                        <tr>
                          <td width="80"><?php echo t("Email"); ?></td><td><input type="text" name="reset-email" /></td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td><td><input type="submit" value="<?php echo t("Reset Password"); ?>" /></td>
                        </tr>
                      </table>
                    </form>
                  </fieldset>
